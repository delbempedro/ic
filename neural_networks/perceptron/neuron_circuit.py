...
class neuron_circuit():
    ...
    def add_phase_qubit_neuron(self,inputs,weights,number_of_inputs=2,first_qubit_index=0,number_of_inputs_per_qubit=3):
        """
        ...
        phase_qubit_neuron(self._qc,inputs,weights,number_of_inputs=number_of_inputs,first_qubit_index=first_qubit_index,number_of_inputs_per_qubit=number_of_inputs_per_qubit)

    def add_amplitude_qubit_neuron(self,parameters,number_of_inputs=2,first_qubit_index=0): 
        """
        Add a neuron to the current quantum circuit.
        
        Parameters:
        weights (list of floats): The weights of the inputs to the neuron.
        number_of_inputs (int): The number of inputs to the neuron.
        first_qubit_index (int): The index of the first qbit that the neuron will use.
        """

        amplitude_qubit_neuron(self._qc,parameters,number_of_inputs=number_of_inputs,first_qubit_index=first_qubit_index)
